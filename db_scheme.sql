...
create table orders(id int not null auto_increment, product_id int not null, client_id int not null, product_individual_number varchar(20), unit_price DECIMAL(12,2), units bigint, transactionValue DECIMAL(12,2), primary key (id), foreign key (product_id) references products(id), foreign key (client_id) references clients(id));
